...
With *height* 5 and *cp_height* 0 on the PandoraCoin Cash chain:
...
**Result**
  ...
  The fee in whole coin units (PDC, not jus for PandoraCoin) as a
...
**Result**
  ...
  each is the appropriate balance in minimum coin units (jus).
...
**Result**
  ...
  * *fee*
    ...
    The transaction fee in minimum coin units (jus).
...
**Result**
  ...
  * *value*
    ...
    The output's value in minimum coin units (jus).
...
Return a banner to be shown in the Quantum console.
...
**Result**
  ...
  * *protocol_min*
    ...
    Strings that are the minimum and maximum Quantum protocol
...
::

  {
      ...
      "protocol_min": "1.0",
      "pruning": null,
      "server_version": "QuantumX 1.0.17",
...
**Example**::
  ...
  server.version("Quantum 3.0.6", ["1.1", "1.2"])
...
**Example Result**::

    {
      ...
      "cbTx": "",
      "deletedMNs": [
      ],
      "mnList": [
        {
