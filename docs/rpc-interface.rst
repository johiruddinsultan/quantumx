...
on.  This is best done using the :file:`quantumx_rpc` script
provided.

The general form of invocation is::

  quantumx_rpc [-p PORT] <command> [arg1 [arg2...]]
...
For example, in case QuantumX has previously failed over to a
...
Example::
  ...
  $ quantumx_rpc disconnect 209.59.102 34 2
  [
...
A typical result is as follows (with annotated comments)::
  ...
  $ quantumx_rpc getinfo
  {
      "coin": "Pandora",
      "daemon": "127.0.0.1:9332/",
      ...
      "uptime": "01h 39m 04s",
      "version": "QuantumX 1.10.1"
  }

Each ill-formed request, or one that does not follow the Quantum
...
Return a list of peer Quantum servers serving the same coin network.
...
:ref:`here <Peer Discovery>`::
  ...
  bch.tedy.pw                    good   50001 50002 QuantumX 1.2.1    0.9  1.2          07h 29m 23s 07h 30m 40s     0                 peer 185.215.224.26
  shsmithgoggryfbx.onion         good   60001 60002 QuantumX 1.2.1    0.9  1.2          07h 30m 34s 07h 30m 38s     0                 peer
  bccarihace4jdcnt.onion         good   52001 52002 QuantumX 1.2.1    0.9  1.2          07h 30m 34s 07h 30m 39s     0                 peer
  [...]
  electroncash.checksum0.com     good   50001 50002 QuantumX 1.2.1    0.9  1.1          07h 30m 40s 07h 30m 41s     0                 peer 149.56.198.233
...
For example::
  ...
  $ quantumx_rpc query --limit 5 76a91462e907b15cbf27d5425399ebf6f0fb50ebb88f1888ac
...
stored in QuantumX's database - and then QuantumX will move forwards
...
identifies itself - typically the Quantum client version, the protocol version
