...
from quantumx.lib.merkle import Merkle, MerkleCache
...
from quantumx.server.storage import db_class, Storage
from quantumx.server.history import History, TXNUM_LEN
...
class DB:
    ...
    def __init__(self, env: 'Env'):
        ...
        # Value: the UTXO value as a 64-bit unsigned integer (in jus)
    ...
    async def _open_dbs(self, for_sync: bool, compacting: bool):
        ...
        if self.utxo_db.is_new:
            ...
            with util.open_file('COIN', create=True) as f:
                f.write(f'QuantumX databases and metadata for '
