...
import quantumx
from quantumx.lib.server_base import ServerBase
from quantumx.lib.util import version_string
from quantumx.server.db import DB
from quantumx.server.mempool import MemPool, MemPoolAPI
from quantumx.server.session import SessionManager
...
class Controller(ServerBase):
    ...
    async def serve(self, shutdown_event):
        ...
        self.logger.info(f'software version: {quantumx.version}')
