...
import quantumx
from quantumx.server.daemon import DaemonError, Daemon
from quantumx.lib.hash import hash_to_hex_str, HASHX_LEN
from quantumx.lib.script import is_unspendable_legacy, is_unspendable_genesis
from quantumx.lib.util import (
    chunks, class_logger, pack_le_uint32, pack_le_uint64, unpack_le_uint64
)
from quantumx.lib.tx import Tx
from quantumx.server.db import FlushData, COMP_TXID_LEN, DB
from quantumx.server.history import TXNUM_LEN

if TYPE_CHECKING:
    from quantumx.lib.coins import Coin
    from quantumx.server.env import Env
    from quantumx.server.controller import Notifications
...
class BlockProcessor:
    ...
    async def check_and_advance_blocks(self, raw_blocks):
        ...
        if hprevs == chain:
            ...
            # pandorad returns doesn't form a chain because it
    ...
    approximately 42 million UTXOs on pandora mainnet at height
    433,000.
    ...
    async def _first_caught_up(self):
        ...
        await self.flush(True)
        if first_sync:
            self.logger.info(f'{quantumx.version} synced to '
    ...
    async def fetch_and_process_blocks(self, caught_up_event):
        ...
        This is mainly because if, during initial sync QuantumX is
